...
CREATE TABLE `pms_attr`  (
  ...
  `attr_name` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '属性名',
  `search_type` tinyint(4) NULL DEFAULT NULL COMMENT '是否需要检索[0-不需要，1-需要]',
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '属性图标',
  `value_select` char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '可选值列表[用逗号分隔]',
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '入网型号', 1, 'xxx', 'NOH-AL00/NOH-AL10;LIO-AL00', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (2, '上市时间', 1, 'xxx', '2019;2010', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (3, '机身重量', 0, 'xxx', '0.55kg;1.22kg', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (4, '机身长度（mm）', 0, 'xxx', '146.7;150.1', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (5, '机身材质', 0, 'xxx', '其他', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (6, 'GPU型号', 0, 'xxx', 'Mali-G78', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (7, 'CPU品牌', 0, 'xxx', '华为（HUAWEI）', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (8, '颜色', 0, 'xxx', '黑色;红色;白色;灰色', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (9, '内存', 0, 'xxx', '8GB;16GB;32GB', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (10, '版本', 0, 'xxx', ' 8GB+128GB; 8GB+256GB', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (11, '主屏幕尺寸', 0, 'xxx', '6.28英寸', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (12, '屏幕材质类型', 0, 'xxx', 'AMOLED曲面屏', 1, 1, 225, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1, 1, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (2, 2, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (3, 3, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (4, 4, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (6, 6, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (7, 7, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (8, 5, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (9, 11, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 12, 4, NULL);
...
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '主体', 1, '主体', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (2, '基本信息', 2, '基本信息', 'xx', 225);
INSERT INTO `pms_attr_group` VALUES (3, '主芯片', 3, '主芯片', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (4, '屏幕', 4, '屏幕', 'xxx', 225);
...
CREATE TABLE `pms_brand`  (
  ...
  `logo` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '品牌logo地址',
  `descript` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '介绍',
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1, '小米', 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-11-28/2688e822-01d9-4961-8444-91637eae44bd_xiaomi.png', '小米', 1, 'X', 1);
INSERT INTO `pms_brand` VALUES (2, '华为', 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-11-28/cf9deaab-d14c-4e6c-8699-c31548b948d5_huawei.png', '华为', 1, 'H', 2);
INSERT INTO `pms_brand` VALUES (3, '苹果', 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-11-28/b3b92f04-af24-4c3b-85dd-f7864a9c251c_apple.png', '苹果', 1, 'P', 3);
INSERT INTO `pms_brand` VALUES (4, 'oppo', 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-11-28/a07cab6e-439c-47d1-83a2-0843224d76c2_oppo.png', 'oppo', 1, 'O', 4);
INSERT INTO `pms_brand` VALUES (5, '联想', 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-11-28/93e64fbf-8d52-44f1-8d1d-9a85ea70cce3_lenovo.png', '联想', 1, 'L', 5);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1445 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_category
-- ----------------------------
INSERT INTO `pms_category` VALUES (1, '图书、音像、电子书刊', 0, 1, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (2, '手机', 0, 1, 1, 1, 'xxx', NULL, 0);
...
INSERT INTO `pms_category` VALUES (21, '整车', 0, 1, 1, 22, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (22, '电子书刊', 1, 4, 1, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (33, '其他', 1, 2, 1, 12, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (34, '手机通讯', 2, 2, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (35, '运营商', 2, 2, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (36, '手机配件', 2, 2, 1, 2, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (155, '水果', 20, 2, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (156, '猪牛羊肉', 20, 2, 1, 2, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (157, '海鲜水产', 20, 2, 1, 3, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (158, '禽肉蛋品', 20, 2, 1, 4, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (159, '冷冻食品', 20, 2, 1, 5, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (160, '熟食腊味', 20, 2, 1, 6, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (161, '饮品甜品', 20, 2, 1, 7, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (162, '蔬菜', 20, 2, 1, 11, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (163, '全新整车', 21, 2, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (164, '二手车', 21, 2, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (165, '电子书', 22, 5, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (166, '网络原创', 22, 5, 1, 2, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (167, '数字杂志', 22, 5, 1, 4, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (168, '多媒体图书', 22, 5, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (169, '音乐', 23, 3, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (170, '影视', 23, 3, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (171, '教育音像', 23, 3, 1, 2, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (1424, '111', 21, 2, 1, 2, '11', '1', 0);
INSERT INTO `pms_category` VALUES (1425, '222', 21, 3, 1, 3, '22', '个', 0);
INSERT INTO `pms_category` VALUES (1444, '狗子111', 21, 2, 1, 4, '', '', NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (1, 1, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (2, 1, 250, '小米', '平板电视');
INSERT INTO `pms_category_brand_relation` VALUES (3, 1, 449, '小米', '笔记本');
INSERT INTO `pms_category_brand_relation` VALUES (4, 1, 379, '小米', '便携/无线音箱');
INSERT INTO `pms_category_brand_relation` VALUES (5, 2, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (6, 2, 449, '华为', '笔记本');
INSERT INTO `pms_category_brand_relation` VALUES (7, 3, 225, '苹果', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (8, 3, 449, '苹果', '笔记本');
INSERT INTO `pms_category_brand_relation` VALUES (9, 3, 233, '苹果', '蓝牙耳机');
INSERT INTO `pms_category_brand_relation` VALUES (10, 3, 243, '苹果', 'iPhone 配件');
INSERT INTO `pms_category_brand_relation` VALUES (11, 4, 225, 'oppo', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (12, 5, 225, '联想', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (13, 5, 449, '联想', '笔记本');
...
CREATE TABLE `pms_comment_replay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品评价回复关系' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu属性值' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (29, 5, 1, '入网型号', 'A2404', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (30, 5, 2, '上市时间', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (31, 5, 3, '机身重量', '1.62kg', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (32, 5, 4, '机身长度（mm）', '146.7', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (33, 5, 5, '机身材质', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (34, 5, 6, 'GPU型号', 'ios15', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (35, 5, 7, 'CPU品牌', 'Apple', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (43, 3, 1, '入网型号', 'NOH-AL00/NOH-AL10', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (44, 3, 2, '上市时间', '2010', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (45, 3, 3, '机身重量', '0.55kg', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (46, 3, 4, '机身长度（mm）', '150.1', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (47, 3, 5, '机身材质', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (48, 3, 6, 'GPU型号', 'Mali-G78', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (49, 3, 7, 'CPU品牌', '华为（HUAWEI）', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (59, 7, 1, '入网型号', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (60, 7, 2, '上市时间', '2021年', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (61, 7, 3, '机身重量', '2.05kg', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (62, 7, 4, '机身长度（mm）', '163.5', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (63, 7, 5, '机身材质', '玻璃', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (64, 7, 6, 'GPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (65, 7, 7, 'CPU品牌', '高通(Qualcomm)', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (66, 7, 11, '主屏幕尺寸', '6.73英寸', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (67, 7, 12, '屏幕材质类型', 'AMOLED曲面屏', NULL, 0);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku图片' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (2, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5df41ae1-0b21-4b69-87c6-ff2bf189c83f_2b1837c6c50add30.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (3, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/f32bd999-41b6-4203-8c65-dd2dc94281b8_8bf441260bffa42f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (4, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (5, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5df41ae1-0b21-4b69-87c6-ff2bf189c83f_2b1837c6c50add30.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (6, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/f32bd999-41b6-4203-8c65-dd2dc94281b8_8bf441260bffa42f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (7, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (8, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/79906962-6107-41f3-8d7b-0d6845951b00_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (9, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/602a5cf3-b582-4edc-89a8-6699280e231d_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (10, 4, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (11, 4, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/79906962-6107-41f3-8d7b-0d6845951b00_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (12, 4, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/602a5cf3-b582-4edc-89a8-6699280e231d_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (13, 5, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (14, 5, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/11bd1623-aa7d-420d-8941-0a0c55491d70_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (15, 5, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/ab331a8d-68bf-48ba-8bf5-0b8af2d40f8d_a83bf5250e14caf2.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (16, 6, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (17, 6, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/16a9983b-5462-4079-8c11-b81c9068d462_1f15cdbcf9e1273c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (18, 6, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/ab331a8d-68bf-48ba-8bf5-0b8af2d40f8d_a83bf5250e14caf2.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (19, 7, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/86ab82da-e9d5-4bbf-84c9-8cd36f41fc32_asdfpp.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (20, 7, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5c07cc10-ec38-4295-8149-461563b98785_jgfdfgn.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (21, 8, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/86ab82da-e9d5-4bbf-84c9-8cd36f41fc32_asdfpp.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (22, 8, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5c07cc10-ec38-4295-8149-461563b98785_jgfdfgn.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (23, 9, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/2c822baa-4fb0-4ae6-8d91-36e988c109b3_pingugo.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (24, 9, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/7432d5ca-4347-4432-8b73-55e170a92ab2_u=2107640734.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (25, 10, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/2c822baa-4fb0-4ae6-8d91-36e988c109b3_pingugo.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (26, 10, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/7432d5ca-4347-4432-8b73-55e170a92ab2_u=2107640734.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (27, 11, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/b4e4fbe2-51b3-44c2-82c6-2e80c8c035d5_下载.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (28, 11, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/8b38512b-04fb-42d1-841d-100477600041_2345654gfgjdxzde.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (29, 12, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/b4e4fbe2-51b3-44c2-82c6-2e80c8c035d5_下载.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (30, 12, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/8b38512b-04fb-42d1-841d-100477600041_2345654gfgjdxzde.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (31, 13, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/c20adc1e-ae15-4aa4-8080-36a8332405dd_asdfasdy.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (32, 13, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/378c03c8-5daf-45b2-88f0-03e3cd3bb2fa_asdfasdf.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (33, 14, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/c20adc1e-ae15-4aa4-8080-36a8332405dd_asdfasdy.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (34, 14, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/378c03c8-5daf-45b2-88f0-03e3cd3bb2fa_asdfasdf.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (35, 15, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/b592ac3b-cb89-45b1-8321-af950788d5d0_ceJ59VQXiXxF2.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (36, 15, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (37, 15, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/83bd900f-6733-4139-83de-642f1727f4bf_11183e856a0e7a2a.jpg(3).avif', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (38, 15, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (39, 16, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/b592ac3b-cb89-45b1-8321-af950788d5d0_ceJ59VQXiXxF2.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (40, 16, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (41, 16, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/83bd900f-6733-4139-83de-642f1727f4bf_11183e856a0e7a2a.jpg(3).avif', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (42, 16, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (43, 17, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/1b3577de-dc98-4152-8256-3b9f026c7ee9_01355403.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (44, 17, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/851bb543-3d4a-40ce-8262-6f7c4172b638_28662778061342481.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (45, 17, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (46, 17, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (47, 18, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/1b3577de-dc98-4152-8256-3b9f026c7ee9_01355403.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (48, 18, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/851bb543-3d4a-40ce-8262-6f7c4172b638_28662778061342481.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (49, 18, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (50, 18, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (51, 19, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/1d14f6a1-74bb-4e61-8867-5b870f7fbaa3_aa5cc351845a563d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (52, 19, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (53, 19, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (54, 19, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/fae9ce10-19b6-49fa-8db6-801bcfb25f78_4bee50d2947f1775.jpg.avif', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (55, 20, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/1d14f6a1-74bb-4e61-8867-5b870f7fbaa3_aa5cc351845a563d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (56, 20, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (57, 20, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (58, 20, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/fae9ce10-19b6-49fa-8db6-801bcfb25f78_4bee50d2947f1775.jpg.avif', NULL, 1);
...
CREATE TABLE `pms_sku_info`  (
  ...
  `sku_desc` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'sku介绍描述',
  ...
  `sku_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标题',
  `sku_subtitle` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '副标题',
  `price` decimal(18, 4) NULL DEFAULT NULL COMMENT '价格',
  `sale_count` bigint(20) NULL DEFAULT NULL COMMENT '销量',
  PRIMARY KEY (`sku_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 3, '华为 HUAWEI Mate 40 Pro 亮黑色  8GB+128GB', NULL, 225, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 40 Pro 亮黑色  8GB+128GB 4G 全网通 麒麟9000旗舰芯片', '【华为Mate40Pro】限时优惠300元,到手价6299,速来抢购！华为手机热销爆款，限量抢购，猛戳》》》', 5789.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 3, '华为 HUAWEI Mate 40 Pro 亮黑色  8GB+256GB', NULL, 225, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5df41ae1-0b21-4b69-87c6-ff2bf189c83f_2b1837c6c50add30.jpg', '华为 HUAWEI Mate 40 Pro 亮黑色  8GB+256GB 4G 全网通 麒麟9000旗舰芯片', '【华为Mate40Pro】限时优惠300元,到手价6299,速来抢购！华为手机热销爆款，限量抢购，猛戳》》》', 6289.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 3, '华为 HUAWEI Mate 40 Pro 罗兰紫  8GB+128GB', NULL, 225, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 40 Pro 罗兰紫  8GB+128GB 4G 全网通 麒麟9000旗舰芯片', '【华为Mate40Pro】限时优惠300元,到手价6299,速来抢购！华为手机热销爆款，限量抢购，猛戳》》》', 5789.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 3, '华为 HUAWEI Mate 40 Pro 罗兰紫  8GB+256GB', NULL, 225, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 40 Pro 罗兰紫  8GB+256GB 4G 全网通 麒麟9000旗舰芯片', '【华为Mate40Pro】限时优惠300元,到手价6299,速来抢购！华为手机热销爆款，限量抢购，猛戳》》》', 6289.0000, 0);
INSERT INTO `pms_sku_info` VALUES (5, 3, '华为 HUAWEI Mate 40 Pro 星河银  8GB+128GB', NULL, 225, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 40 Pro 星河银  8GB+128GB 4G 全网通 麒麟9000旗舰芯片', '【华为Mate40Pro】限时优惠300元,到手价6299,速来抢购！华为手机热销爆款，限量抢购，猛戳》》》', 5789.0000, 0);
INSERT INTO `pms_sku_info` VALUES (6, 3, '华为 HUAWEI Mate 40 Pro 星河银  8GB+256GB', NULL, 225, 2, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 40 Pro 星河银  8GB+256GB 4G 全网通 麒麟9000旗舰芯片', '【华为Mate40Pro】限时优惠300元,到手价6299,速来抢购！华为手机热销爆款，限量抢购，猛戳》》》', 6289.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 5, 'Apple iPhone 12 红色 128GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/86ab82da-e9d5-4bbf-84c9-8cd36f41fc32_asdfpp.png', 'Apple iPhone 12 红色 128GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 5, 'Apple iPhone 12 红色 64GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/86ab82da-e9d5-4bbf-84c9-8cd36f41fc32_asdfpp.png', 'Apple iPhone 12 红色 64GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (9, 5, 'Apple iPhone 12 白色 128GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/2c822baa-4fb0-4ae6-8d91-36e988c109b3_pingugo.png', 'Apple iPhone 12 白色 128GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (10, 5, 'Apple iPhone 12 白色 64GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/2c822baa-4fb0-4ae6-8d91-36e988c109b3_pingugo.png', 'Apple iPhone 12 白色 64GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (11, 5, 'Apple iPhone 12 绿色 128GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/b4e4fbe2-51b3-44c2-82c6-2e80c8c035d5_下载.jpg', 'Apple iPhone 12 绿色 128GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 5, 'Apple iPhone 12 绿色 64GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/b4e4fbe2-51b3-44c2-82c6-2e80c8c035d5_下载.jpg', 'Apple iPhone 12 绿色 64GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (13, 5, 'Apple iPhone 12 蓝色 128GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/c20adc1e-ae15-4aa4-8080-36a8332405dd_asdfasdy.png', 'Apple iPhone 12 蓝色 128GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (14, 5, 'Apple iPhone 12 蓝色 64GB', NULL, 225, 3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/c20adc1e-ae15-4aa4-8080-36a8332405dd_asdfasdy.png', 'Apple iPhone 12 蓝色 64GB 支持移动联通电信5G 双卡双待手机', '【限时特惠】加99元得20W快充头！加799元得AirPods！更多优惠！', 4799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (15, 7, '小米12 Pro 黑色  8GB+256GB', NULL, 225, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/83bd900f-6733-4139-83de-642f1727f4bf_11183e856a0e7a2a.jpg(3).avif', '小米12 Pro 黑色  8GB+256GB 骁龙8 Gen1 2K AMOLED 120Hz高刷 5000万疾速影像 120W小米澎湃秒充', '【白条24期免息】全新一代骁龙8移动平台,120W小米澎湃快充,4600mAh大电量,5000万高清主摄【点击抢购小米12】查看>', 5399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (16, 7, '小米12 Pro 黑色  8GB+128GB', NULL, 225, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/83bd900f-6733-4139-83de-642f1727f4bf_11183e856a0e7a2a.jpg(3).avif', '小米12 Pro 黑色  8GB+128GB 骁龙8 Gen1 2K AMOLED 120Hz高刷 5000万疾速影像 120W小米澎湃秒充', '【白条24期免息】全新一代骁龙8移动平台,120W小米澎湃快充,4600mAh大电量,5000万高清主摄【点击抢购小米12】查看>', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 7, '小米12 Pro 蓝色  8GB+256GB', NULL, 225, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/851bb543-3d4a-40ce-8262-6f7c4172b638_28662778061342481.jpg', '小米12 Pro 蓝色  8GB+256GB 骁龙8 Gen1 2K AMOLED 120Hz高刷 5000万疾速影像 120W小米澎湃秒充', '【白条24期免息】全新一代骁龙8移动平台,120W小米澎湃快充,4600mAh大电量,5000万高清主摄【点击抢购小米12】查看>', 5399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 7, '小米12 Pro 蓝色  8GB+128GB', NULL, 225, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', '小米12 Pro 蓝色  8GB+128GB 骁龙8 Gen1 2K AMOLED 120Hz高刷 5000万疾速影像 120W小米澎湃秒充', '【白条24期免息】全新一代骁龙8移动平台,120W小米澎湃快充,4600mAh大电量,5000万高清主摄【点击抢购小米12】查看>', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 7, '小米12 Pro 原野绿  8GB+256GB', NULL, 225, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', '小米12 Pro 原野绿  8GB+256GB 骁龙8 Gen1 2K AMOLED 120Hz高刷 5000万疾速影像 120W小米澎湃秒充', '【白条24期免息】全新一代骁龙8移动平台,120W小米澎湃快充,4600mAh大电量,5000万高清主摄【点击抢购小米12】查看>', 5399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 7, '小米12 Pro 原野绿  8GB+128GB', NULL, 225, 1, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/fae9ce10-19b6-49fa-8db6-801bcfb25f78_4bee50d2947f1775.jpg.avif', '小米12 Pro 原野绿  8GB+128GB 骁龙8 Gen1 2K AMOLED 120Hz高刷 5000万疾速影像 120W小米澎湃秒充', '【白条24期免息】全新一代骁龙8移动平台,120W小米澎湃快充,4600mAh大电量,5000万高清主摄【点击抢购小米12】查看>', 4699.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '销售属性名',
  `attr_value` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '销售属性值',
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 8, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 10, '版本', ' 8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 8, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 10, '版本', ' 8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 8, '颜色', '罗兰紫', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 10, '版本', ' 8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 4, 8, '颜色', '罗兰紫', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 10, '版本', ' 8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 5, 8, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 5, 10, '版本', ' 8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 6, 8, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 6, 10, '版本', ' 8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 7, 8, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 7, 9, '内存', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 8, 8, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 8, 9, '内存', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 9, 8, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 9, 9, '内存', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 10, 8, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 10, 9, '内存', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 11, 8, '颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 11, 9, '内存', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 12, 8, '颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 12, 9, '内存', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 13, 8, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 13, 9, '内存', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 14, 8, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 14, 9, '内存', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 15, 8, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 15, 10, '版本', ' 8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 16, 8, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 16, 10, '版本', ' 8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 17, 8, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 17, 10, '版本', ' 8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 18, 8, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 18, 10, '版本', ' 8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 8, '颜色', '原野绿', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 19, 10, '版本', ' 8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 8, '颜色', '原野绿', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 20, 10, '版本', ' 8GB+128GB', NULL);
...
CREATE TABLE `pms_spu_comment`  (
  ...
  `spu_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名字',
  ...
  `member_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员ip',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `show_status` tinyint(1) NULL DEFAULT NULL COMMENT '显示状态[0-不显示，1-显示]',
  `spu_attributes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '购买时属性组合',
  ...
  `member_icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户头像',
...
CREATE TABLE `pms_spu_images`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT 'spu_id',
  `img_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片名',
  `img_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `img_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  `default_img` tinyint(4) NULL DEFAULT NULL COMMENT '是否默认图',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu图片' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (17, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/079716da-439b-4e88-8800-916ad5b8af18_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (18, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/16a9983b-5462-4079-8c11-b81c9068d462_1f15cdbcf9e1273c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (19, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5df41ae1-0b21-4b69-87c6-ff2bf189c83f_2b1837c6c50add30.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (20, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/f32bd999-41b6-4203-8c65-dd2dc94281b8_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (21, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/11bd1623-aa7d-420d-8941-0a0c55491d70_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (22, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/79906962-6107-41f3-8d7b-0d6845951b00_919c850652e98031.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (23, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/ab331a8d-68bf-48ba-8bf5-0b8af2d40f8d_a83bf5250e14caf2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (24, 3, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/602a5cf3-b582-4edc-89a8-6699280e231d_d511faab82abb34b.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (33, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/c20adc1e-ae15-4aa4-8080-36a8332405dd_asdfasdy.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (34, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/378c03c8-5daf-45b2-88f0-03e3cd3bb2fa_asdfasdf.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (35, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/b4e4fbe2-51b3-44c2-82c6-2e80c8c035d5_下载.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (36, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/8b38512b-04fb-42d1-841d-100477600041_2345654gfgjdxzde.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (37, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/86ab82da-e9d5-4bbf-84c9-8cd36f41fc32_asdfpp.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (38, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5c07cc10-ec38-4295-8149-461563b98785_jgfdfgn.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (39, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/2c822baa-4fb0-4ae6-8d91-36e988c109b3_pingugo.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (40, 5, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/7432d5ca-4347-4432-8b73-55e170a92ab2_u=2107640734.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (49, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/1b3577de-dc98-4152-8256-3b9f026c7ee9_01355403.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (50, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/851bb543-3d4a-40ce-8262-6f7c4172b638_28662778061342481.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (51, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/1d14f6a1-74bb-4e61-8867-5b870f7fbaa3_aa5cc351845a563d.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (52, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/b592ac3b-cb89-45b1-8321-af950788d5d0_ceJ59VQXiXxF2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (53, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/35988d61-7be9-46c5-87ac-9257dec285a7_20647b2a9882859d.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (54, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/83bd900f-6733-4139-83de-642f1727f4bf_11183e856a0e7a2a.jpg(3).avif', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (55, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/611b3033-8afc-4c76-813b-303d9acfe43d_636C6DEA2426AC024.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (56, 7, NULL, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/fae9ce10-19b6-49fa-8db6-801bcfb25f78_4bee50d2947f1775.jpg.avif', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  `spu_description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品描述',
  `catalog_id` bigint(20) NULL DEFAULT NULL COMMENT '所属分类id',
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT '品牌id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (3, '华为 HUAWEI Mate 40 Pro', '华为 HUAWEI Mate 40 Pro', 225, 2, 0.5500, 1, '2021-12-04 11:34:24', '2022-04-12 06:15:31');
INSERT INTO `pms_spu_info` VALUES (5, 'Apple iPhone 12', 'Apple iPhone 12', 225, 3, 0.3500, 1, '2021-12-04 12:50:52', '2022-04-12 06:17:46');
INSERT INTO `pms_spu_info` VALUES (7, '小米12 Pro', '小米12 Pro', 225, 1, 0.2050, 1, '2022-04-27 12:08:28', '2022-04-27 04:10:51');
...
CREATE TABLE `pms_spu_info_desc`  (
  ...
  `decript` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品介绍',
  PRIMARY KEY (`spu_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu信息介绍' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_spu_info_desc
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (3, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/5ca98338-8e76-41fd-8afb-ee7ef6c9ed06_73366cc235d68202.jpg,https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/dd8dda68-32c9-4f94-8fbf-48cf6bef10c1_528211b97272d88a.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (5, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2021-12-04/41f9903f-4d76-468d-8313-23b02278db80_f205d9c99a2b4b01.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/49e1d981-9cff-4d5a-8c35-8482a3074055_QQ截图20220427114520.png,https://gulimall-hello-2021.oss-cn-beijing.aliyuncs.com/2022-04-27/5af5bb74-e30c-496f-8812-0fb0ca4a546d_QQ截图20220427114617.png');
