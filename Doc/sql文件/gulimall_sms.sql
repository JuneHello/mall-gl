...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品会员价格' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1, 1, 2, '青铜会员', 5689.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 2, 3, '银牌会员', 5589.0000, 1);
INSERT INTO `sms_member_price` VALUES (3, 7, 2, '青铜会员', 4799.0000, 1);
INSERT INTO `sms_member_price` VALUES (4, 7, 3, '银牌会员', 4699.0000, 1);
INSERT INTO `sms_member_price` VALUES (5, 15, 2, '青铜会员', 10.0000, 1);
INSERT INTO `sms_member_price` VALUES (6, 15, 3, '银牌会员', 20.0000, 1);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀活动场次' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (1, '9:00', '2022-05-15 09:00:00', '2022-05-15 11:00:00', 1, '2022-05-14 13:51:44');
INSERT INTO `sms_seckill_session` VALUES (2, '12:00', '2022-05-15 12:00:00', '2022-05-15 18:00:00', 1, '2022-05-14 13:53:39');
INSERT INTO `sms_seckill_session` VALUES (3, '20:00', '2022-05-14 20:00:00', '2022-05-14 23:00:00', 1, '2022-05-14 22:02:20');
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  `seckill_count` int(10) NULL DEFAULT NULL COMMENT '秒杀总量',
  `seckill_limit` int(10) NULL DEFAULT NULL COMMENT '每人限购数量',
  `seckill_sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES (1, NULL, 1, 1, 100, 1, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (2, NULL, 1, 3, 998, 10, 1, 2);
INSERT INTO `sms_seckill_sku_relation` VALUES (3, NULL, 2, 4, 55, 5, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (4, NULL, 3, 1, 10, 7, 2, 1);
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品满减信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1, 1, 10000.0000, 500.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (2, 7, 500.0000, 20.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (3, 17, 4000.0000, 10.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (4, 20, 4000.0000, 10.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品阶梯价格' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 1, 3, 0.98, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (2, 7, 4, 0.75, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (3, 15, 2, 1.00, NULL, 0);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品spu积分设置' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (1, 2, 30.0000, 50.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (2, 3, 30.0000, 50.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 4, 40.0000, 60.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (4, 5, 40.0000, 60.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 7, 100.0000, 100.0000, NULL);
